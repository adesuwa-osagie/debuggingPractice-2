...
step 5) Still getting strange results? consider console.log.
  ----with console.log, when you don't know where the error is coming from, create a range! Find where the code is working, and then where it stops working. That will help narrow down where the problem is.
*/
...
///Intermediate 1) Odd Up, Even Down — N Times
...
///Intermediate 2) Remove Middle Strings 
